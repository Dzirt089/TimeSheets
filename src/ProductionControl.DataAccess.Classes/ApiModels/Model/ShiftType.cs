namespace ProductionControl.DataAccess.Classes.ApiModels.Model
{
	...
	public class ShiftType : EnumerationShift
	{
		...
		/// 2) Затем в <see cref="WorkingScheduleDto.SetShift"/>
		/// 3) Потом в статическом классе <see cref="ExpansionMethodsUtils"/> 
		///		в методы расширения: <see cref="GetDaysHours"/>, <see cref="GetNightHours"/>, <see cref="GetShiftHours"/>
