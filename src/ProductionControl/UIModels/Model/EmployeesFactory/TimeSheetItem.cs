...
namespace ProductionControl.Models.Entitys.EmployeesFactory
{
	...
	public class TimeSheetItem : ObservableObject
	{
		...
		public TimeSheetItem(
			...
			ObservableCollection<ShiftDataDto> workerHours,
			List<int> noWorksDay,
		...
		/// </summary>
		public ObservableCollection<ShiftDataDto> WorkerHours
		{
			get => _workerHours;
			set
			{
		...
		private ObservableCollection<ShiftDataDto> _workerHours;
		...
		{
			if (e.PropertyName == nameof(ShiftDataDto.Hours) || e.PropertyName == nameof(ShiftDataDto.Overday) || e.PropertyName == nameof(ShiftDataDto.Shift))
			{
		...
		public TimeSheetItem Clone()
		{
			return new TimeSheetItem
			{
				...
				CountPreholiday = CountPreholiday,
				FioShiftOverday = FioShiftOverday,
				Id = Id,
				IsLunch = IsLunch,
